...
| Samba (Debian trixie paket sürümü) | —                                                                     | —                                                                                                                                          | **unverified** | VM'de `dpkg -l samba` ile doğrulanacak                  |
...
| Debian trixie `samba` paket sürüm dizesi                   | VM'de `dpkg -l samba`                                                                                    |
| TypeScript 7'nin project references / derleme davranışı    | iskelet kurulurken ampirik                                                                               |
