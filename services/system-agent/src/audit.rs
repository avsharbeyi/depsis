...
pub fn operation_name(request: &Request) -> &'static str {
    match request {
        ...
        Request::OffsiteStatus {} => "offsite_status",
        Request::OffsiteCreateIdentity {} => "offsite_create_identity",
        ...
        Request::ArchiveFolder { .. } => "archive_folder",
        Request::RebootSystem {} => "reboot_system",
        Request::ScanImportablePools {} => "scan_importable_pools",
        ...
        Request::BackupRemoveEntry { .. } => "backup_remove_entry",
        Request::PrepareBackupRoot { .. } => "prepare_backup_root",
        Request::BackupRootStatus { .. } => "backup_root_status",
        Request::LoadBackupKey { .. } => "load_backup_key",
        Request::UnloadBackupKey { .. } => "unload_backup_key",
        ...
        Request::ZerotierControllerStatus {} => "zerotier_controller_status",
        Request::ZerotierControllerNetworks {} => "zerotier_controller_networks",
        Request::ZerotierCreateNetwork { .. } => "zerotier_create_network",
        Request::ZerotierControllerMembers { .. } => "zerotier_controller_members",
        Request::ZerotierSetMemberAuthorized { .. } => "zerotier_set_member_authorized",
        ...
        Request::RevokeSmbCredential { .. } => "revoke_smb_credential",
